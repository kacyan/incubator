...
/**
 * BAPI_CUSTOMER_CREATEFROMDATA1の習作
 * @author kac
 * @since 2013/03/06
 * @version 2013/03/06
 */
public class TestJCoCustomerCreateFromData1
{
	...
	private static Logger	log= Logger.getLogger( TestJCoCustomerCreateFromData1.class );
	...
	{
		String functionName= "BAPI_CUSTOMER_CREATEFROMDATA1";
