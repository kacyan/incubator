...
public class HttpURLConnectionTest
{
	...
	{
		String	url= "http://recc5.dev.ksi.co.jp:8000/sap/public/myssocntl?sap-client=302";
		...
		String	sapMysapred= "http://recc5.dev.ksi.co.jp:8000/sap/bc/webdynpro/sap/appl_soap_management?sap-client=302&sap-language=JA";
		try
		{
			URL	u= new URL( url );
			HttpURLConnection	http= (HttpURLConnection)u.openConnection();

			http.addRequestProperty( "sap-mysapsso", "302"+ mySapSso );
