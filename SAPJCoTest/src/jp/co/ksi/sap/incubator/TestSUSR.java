...
/**
 * 汎用グループSUSRにある汎用モジュールの習作
 * @author kac
 * @since 2013/08/07
 * @version 2013/08/17
 * <pre>
 * 汎用グループSUSRには認証ユーザの情報を取得できる汎用モジュールがありそう
 * SAP-GUIのメニューにある「自分のユーザパラメータの更新」は、SUSRのSU2だ。
 * </pre>
 */
public class TestSUSR
{
	private static Logger	log= Logger.getLogger( TestSUSR.class );
