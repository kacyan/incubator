...
public class RequestDebugFilter implements Filter
{
			...
			FilterChain chain ) throws IOException, ServletException
	{
		if( req instanceof HttpServletRequest)
		{
			...
			log.info( request.getRemoteAddr() +" "+ request.getRemoteUser() +" "+ request.getRequestURL().toString() );
		}
		...
		if( res instanceof HttpServletResponse )
		{
			...
			log.info( response.getBufferSize() +" "+ response.getCharacterEncoding() +" "+ response.getContentType() +" "+ response.getLocale() );
		}
	}
