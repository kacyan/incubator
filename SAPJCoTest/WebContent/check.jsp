...
%>
 ...
 <tr>
  ...
  <td><%=request.getLocale() %>
   <ul style="font-size:75%; margin-top:0px; margin-bottom:0px; color:gray;">
<%
java.util.Locale	locale= request.getLocale();
try
{
%>    <li>language= <%=locale.getLanguage() %></li>
    <li>country= <%=locale.getCountry() %></li>
    <li>variant= <%=locale.getVariant() %></li>
    <li>displayLanguage <%=locale.getDisplayLanguage() %></li>
    <li>displayCountry= <%=locale.getDisplayCountry() %></li>
    <li>displayVariant= <%=locale.getDisplayVariant() %></li>
    <li>displayName= <%=locale.getDisplayName() %></li>
    <li>ISO3Language= <%=locale.getISO3Language() %></li>
    <li>ISO3Country= <%=locale.getISO3Country() %></li>
<%
}
catch( Exception e )
{
