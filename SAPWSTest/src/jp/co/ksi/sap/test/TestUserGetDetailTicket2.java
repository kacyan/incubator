...
import mc_style.functions.soap.sap.document.sap_com.UserGetDetailTicket2Service2Locator;
import mc_style.functions.soap.sap.document.sap_com.UserGetDetailTicketBind1Stub;
import mc_style.functions.soap.sap.document.sap_com.UserGetDetailTicketBind2Stub;
...
public class TestUserGetDetailTicket2
{

	private static Logger	log= Logger.getLogger( TestUserGetDetailTicket2.class );
...
//		ssoTicket= "!B47Lr!SRFHxMni7HS6i4UICAlsbwH5AU5bW52ST3cElPASiYkciYlKM9Dc0vcTx!jhN1j7Dw7tp71Rpxs3t6yBY3S1CpanVCURxLjm4VBVINmRX9fJQVXFuNtpcC9dCr1IcJ4LenmSHWJgFJ/QsK4R8hk6GUeFYAgvsbbTAhUAjCnu6GdzaKBE1tG5z4ksen6cSAsCgYEA1oenEWTrY/SGknhHZAHlFQOCs7XiSHV8vdG7IgZ1Da!5iLRpZ6yiyenVwEH16ifS5epjmVuFCNFrZJbbsrQv!19JyOfx0kHRVrDGYyZhtrmARbMpl8BEq5QvsEZbcLAft3XaaCpJozizCULViKILZWBAKx!OsFYwGB6N0gTfXS0DgYQAAoGAW!LcxvMveSAALvtINAMve8Ys/FCefVIxrV7pjdIG2UP5!SQBhmuuMV7ITLLwURaRZKXBbIj64I6R3VgFN9MGvtADA3Wa2hX0FuqY6U40fHuGMMzuM379xBbWCT0IaFw!!gouw3zjq02qZ2MFUc1kyQFMAkGByqGSM44BAMELjAsAhQe!sNTQRq0KRTRvRVuVnm3IOAJcgIUK6UYSoZ9n3iPD!!R/zUOrU4tjLU=";
		...
		try
		{
			...
			UserGetDetailTicket2Service2Locator	locator= new UserGetDetailTicket2Service2Locator();
			ZUserGetDetail	zUserGetDetail= locator.getUserGetDetailTicketBind2();
			
			if( zUserGetDetail instanceof UserGetDetailTicketBind2Stub )
			{//	スタブがあるなら、認証情報を付加する
				UserGetDetailTicketBind2Stub	stub= (UserGetDetailTicketBind2Stub)zUserGetDetail;
